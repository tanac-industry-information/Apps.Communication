...
namespace Apps.Communication.Profinet.Omron
{
	...
	/// 需要特别注意<see cref="P:Communication.Profinet.Omron.OmronFinsNet.ReadSplits" />属性，在超长数据读取时，规定了切割读取的长度，在不是CP1H及扩展模块的时候，可以设置为999，提高一倍的通信速度。
	/// </remarks>
	/// <example>
	/// 地址列表：
	/// 地址支持的列表如下：
	...
	public class OmronFinsNet : NetworkDeviceBase
	{
		...
		public OmronFinsNet()
		{
			...
			base.ByteTransform.IsStringReverseByteWord = false;
		}
