...
namespace Apps.Communication.Profinet.Melsec
{
	...
	/// <see cref="T:Communication.Profinet.Melsec.MelsecMcNet" />，<see cref="T:Communication.Profinet.Melsec.MelsecMcAsciiNet" />，<see cref="T:Communication.Profinet.Melsec.MelsecMcUdp" />, <see cref="T:Communication.Profinet.Melsec.MelsecMcAsciiUdp" /> 这四个类都是MC协议的Qna兼容3E帧实现，分别
	/// 是TCP二进制，TCP的ASCII，UDP的二进制，UDP的ASCI格式。适用Q系列，L系列，FX5U系列，还有以太网模块QJ71E71。<br />
	/// <see cref="T:Communication.Profinet.Melsec.MelsecA1ENet" />, <see cref="T:Communication.Profinet.Melsec.MelsecA1EAsciiNet" /> 这两个类是MC协议的Qna兼容1E协议实现，
	/// 分别是二进制和ASCII格式的实现，主要适用A系列的PLC，Fx3u，已经有些老的PLC，使用了北辰模块实现了通信。<br />
	/// <see cref="T:Communication.Profinet.Melsec.MelsecA3CNet" /> 是MC协议的3C帧的实现，主要支持串行通信的模块的实现。<br />
	/// <see cref="T:Communication.Profinet.Melsec.MelsecFxSerial" /> 是FX编程口的协议的实现，测试不太稳定。具体支持的系列需要参照类的说明。<br />
	/// <br />
