...
namespace Apps.Communication.Profinet.Melsec
{
	...
	/// </example>
	public class MelsecMcUdp : NetworkUdpDeviceBase, IReadWriteMc, IReadWriteDevice, IReadWriteNet
	{
		...
		/// <inheritdoc cref="M:Communication.Profinet.Melsec.MelsecMcUdp.ReadTags(System.String,System.UInt16)" />
