...
namespace Apps.Communication.Robot.KUKA
{
	/// <summary>
	...
	public class KukaTcpNet : NetworkDoubleBase, IRobotNet
	{
		...
		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.Read(System.String)" />
		...
		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.ReadString(System.String)" />
		...
		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.Write(System.String,System.Byte[])" />
		public async Task<OperateResult> WriteAsync(string address, byte[] value)
		{
			return await WriteAsync(address, Encoding.Default.GetString(value));
		}

		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.Write(System.String,System.String)" />
		...
		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.StartProgram(System.String)" />
		public async Task<OperateResult> StartProgramAsync(string program)
		{
			return await ReadCmdAsync("03" + program);
		}

		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.ResetProgram" />
		public async Task<OperateResult> ResetProgramAsync()
		{
			return await ReadCmdAsync("0601");
		}

		/// <inheritdoc cref="M:Communication.Robot.KUKA.KukaTcpNet.StopProgram" />
