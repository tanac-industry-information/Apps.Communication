...
using Apps.Communication.Enthernet;
...
namespace Apps.Communication.Robot.ABB
{
	...
	/// 支持和<see cref="T:Communication.Robot.ABB.ABBWebApiClient" />进行测试通信。本服务器的运行需要商业授权支持，否则只能运行24小时。
	/// </remarks>
	public class ABBWebApiServer : HttpServer
	{
		...
		/// <inheritdoc cref="M:Communication.Enthernet.HttpServer.HandleRequest(System.Net.HttpListenerRequest,System.Net.HttpListenerResponse,System.String)" />
