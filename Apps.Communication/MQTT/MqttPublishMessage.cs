...
{
	/// <summary>
	/// Mqtt发送的消息封装对象，是对 <see cref="T:Communication.MQTT.MqttApplicationMessage" /> 对象的封装，添加了序号，还有是否重发的信息<br />
	/// The message encapsulation object sent by Mqtt is an encapsulation of the <see cref="T:Communication.MQTT.MqttApplicationMessage" /> object, with the serial number added, and whether to retransmit
	/// </summary>
