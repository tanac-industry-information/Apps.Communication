...
{
	/// <summary>
	/// <seealso cref="T:Communication.LogNet.LogStatistics" />的词典集合类，用于多个数据的统计信息，例如可以统计多个规格的产量信息，统计多个方法的调用次数信息<br />
	/// The dictionary collection class of <seealso cref="T:Communication.LogNet.LogStatistics" /> is used for the statistical information of multiple data, for example, 
	...
	public class LogStatisticsDict
	{
		...
		/// <summary>
		/// 根据给定的关键字信息，获取相关的 <seealso cref="T:Communication.LogNet.LogStatistics" /> 对象，进而执行很多的操作<br />
		/// According to the given keyword information, obtain related <seealso cref="T:Communication.LogNet.LogStatistics" /> objects, and then perform many operations
		/// </summary>
		...
		/// <summary>
		/// 手动新增一个<seealso cref="T:Communication.LogNet.LogStatistics" />对象，需要指定相关的关键字<br />
		/// Manually add a <seealso cref="T:Communication.LogNet.LogStatistics" /> object, you need to specify related keywords
		/// </summary>
		...
		/// <summary>
		/// 移除一个<seealso cref="T:Communication.LogNet.LogStatistics" />对象，需要指定相关的关键字，如果关键字本来就存在，返回 <c>True</c>, 如果不存在，返回 <c>False</c> <br />
		/// To remove a <seealso cref="T:Communication.LogNet.LogStatistics" /> object, you need to specify the relevant keyword. If the keyword already exists, return <c>True</c>, if it does not exist, return <c>False</c>
		/// </summary>
		/// <param name="key">关键字信息</param>
		...
		/// <summary>
		/// 从指定的文件加载对应的统计信息，通常是调用<see cref="M:Communication.LogNet.LogStatisticsDict.SaveToFile(System.String)" />方法存储的文件，如果文件不存在，将会跳过加载<br />
		/// Load the corresponding statistical information from the specified file, usually the file stored by calling the <see cref="M:Communication.LogNet.LogStatisticsDict.SaveToFile(System.String)" /> method. 
