...
namespace Apps.Communication.Language
{
	/// <summary>
	...
	public class English : DefaultLanguage
	{
		...
		public override string AuthorizationFailed => "System authorization failed, need to use activation code authorization, thank you for your support. Active device number：";
