...
namespace Apps.Communication.Core.Address
{
	...
	public class GeSRTPAddress : DeviceAddressDataBase
	{
		...
		/// <inheritdoc cref="M:Communication.Core.Address.GeSRTPAddress.ParseFrom(System.String,System.UInt16,System.Boolean)" />
		...
		/// <summary>
		/// 从GE的地址里，解析出实际的带数据码的 <see cref="T:Communication.Core.Address.GeSRTPAddress" /> 地址信息，起始地址会自动减一，和实际的地址相匹配
		/// </summary>
