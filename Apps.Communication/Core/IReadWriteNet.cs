...
namespace Apps.Communication.Core
{
	...
	public interface IReadWriteNet
	{
		...
		/// <summary>
		/// 读取支持Hsl特性的数据内容，该特性为<see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />，详细参考api文档说明<br />
		/// Read the data content of the Hsl attribute. The attribute is <see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />, please refer to the api documentation for details.
		/// </summary>
		...
		/// <summary>
		/// 写入支持Hsl特性的数据，返回是否写入成功，该特性为<see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />，详细参考api文档说明<br />
		/// Write data that supports the Hsl attribute, and return whether the write was successful. The attribute is <see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />, please refer to the api documentation for details.
		/// </summary>
		/// <typeparam name="T">自定义的数据类型对象</typeparam>
		/// <returns>包含是否成功的结果对象</returns>
		/// <example>
		...
		/// <summary>
		/// 读取结构体类型的数据，根据结构体自身的定义，读取原始字节数组，然后解析出实际的结构体数据，结构体需要实现<see cref="T:Communication.Reflection.HslStructAttribute" />特性
		/// </summary>
		...
		/// <summary>
		/// 异步读取支持Hsl特性的数据内容，该特性为<see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />，详细参考api文档说明<br />
		/// Asynchronously read the data content of the Hsl attribute. The attribute is <see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />, please refer to the api documentation for details.
		/// </summary>
		/// <typeparam name="T">自定义的数据类型对象</typeparam>
		/// <returns>包含是否成功的结果对象</returns>
		/// <example>
		...
		/// <summary>
		/// 异步写入支持Hsl特性的数据，返回是否写入成功，该特性为<see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />，详细参考api文档说明<br />
		/// Asynchronously write data that supports the Hsl attribute, and return whether the write was successful. The attribute is <see cref="T:Communication.Reflection.HslDeviceAddressAttribute" />, please refer to the api documentation for details.
		/// </summary>
		/// <typeparam name="T">自定义的数据类型对象</typeparam>
		/// <returns>包含是否成功的结果对象</returns>
		/// <example>
